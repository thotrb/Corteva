    ...
    <div class="d-flex" >
        ...
        <div class="col">
            ...
            <template v-if="show===1">
                ...
                {{formulationsPerMonth[0]['January']}}
                ...
                <div class="table-info-data">
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <th scope="row"></th>
                                <td>{{sumPerMonth[0]['January']}}</td>
                                <td>{{sumPerMonth[0]['February']}}</td>
                                <td>{{sumPerMonth[0]['March']}}</td>
                                <td>{{sumPerMonth[0]['April']}}</td>
                                <td>{{sumPerMonth[0]['May']}}</td>
                                <td>{{sumPerMonth[0]['June']}}</td>
                                <td>{{sumPerMonth[0]['July']}}</td>
                                <td>{{sumPerMonth[0]['August']}}</td>
                                <td>{{sumPerMonth[0]['September']}}</td>
                                <td>{{sumPerMonth[0]['October']}}</td>
                                <td>{{sumPerMonth[0]['November']}}</td>
                                <td>{{sumPerMonth[0]['December']}}</td>
                            </tr>
            ...
            <template v-if="show===1">
                ...
                <div class="table-info-data">
                    <table class="table">
                        ...
                        <tr>
                            <th scope="row"></th>
                            <td>{{sumPerMonth2[0]['January']}}</td>
                            <td>{{sumPerMonth2[0]['February']}}</td>
                            <td>{{sumPerMonth2[0]['March']}}</td>
                            <td>{{sumPerMonth2[0]['April']}}</td>
                            <td>{{sumPerMonth2[0]['May']}}</td>
                            <td>{{sumPerMonth2[0]['June']}}</td>
                            <td>{{sumPerMonth2[0]['July']}}</td>
                            <td>{{sumPerMonth2[0]['August']}}</td>
                            <td>{{sumPerMonth2[0]['September']}}</td>
                            <td>{{sumPerMonth2[0]['October']}}</td>
                            <td>{{sumPerMonth2[0]['November']}}</td>
                            <td>{{sumPerMonth2[0]['December']}}</td>
                        </tr>
        ...
        <div class="col">
            ...
            <canvas id="formulationSplit" width="200" height="200"/>

            <br/>
            <br/>
            <canvas id="packsizeSplit" width="200" height="200"/>
